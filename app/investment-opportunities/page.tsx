...
<a href="/login" className="px-6 py-2 border border-primary text-primary font-label-caps hover:bg-surface-container-high transition-colors inline-flex items-center">Login</a>
...
<main className="mx-auto w-full min-w-0 max-w-container-max overflow-x-hidden px-margin-mobile md:px-margin-desktop py-12">
{/* Dashboard Header */}
<section className="mb-12 min-w-0">
<h1 className="font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-4">Investment Portal</h1>
...
<section className="grid min-w-0 grid-cols-1 gap-gutter mb-16 md:grid-cols-4">
...
{/* Search & Filter Bar */}
<section className="mb-12 flex min-w-0 flex-col gap-gutter md:flex-row md:items-center md:justify-between">
<div className="relative w-full min-w-0 md:w-1/3">
...
<div className="-mx-1 flex min-w-0 max-w-full gap-2 overflow-x-auto pb-2 [-webkit-overflow-scrolling:touch] [scrollbar-width:thin] md:mx-0 md:w-auto md:flex-wrap md:overflow-visible md:pb-0 md:gap-4">
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-primary text-on-primary font-label-caps whitespace-nowrap rounded-lg">All Sectors</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Mining</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Agri-Tech</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Renewables</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Logistics</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Rwanda</button>
<button type="button" className="shrink-0 px-4 py-2 sm:px-5 bg-surface-container border border-outline-variant text-on-surface font-label-caps whitespace-nowrap rounded-lg hover:bg-surface-container-high">Guinea</button>
</div>
</section>
{/* Content Grid with Sidebar */}
<div className="grid min-w-0 grid-cols-1 gap-gutter lg:grid-cols-12">
{/* Main Grid */}
<div className="min-w-0 lg:col-span-8 grid grid-cols-1 gap-gutter sm:grid-cols-2">
{/* Opportunity Card 1 */}
...
<div className="flex flex-wrap justify-between gap-x-3 gap-y-2 items-start mb-4">
<span className="shrink-0 px-3 py-1 bg-tertiary-fixed text-on-tertiary-fixed text-[10px] font-label-caps rounded-full uppercase">Renewables</span>
<span className="font-data-tabular text-on-surface-variant flex shrink-0 items-center">
<span className="material-symbols-outlined text-[14px] mr-1">location_on</span> Rwanda
                            </span>
</div>
<h3 className="font-headline-sm text-headline-sm text-primary mb-2 min-w-0 break-words">Kigali Smart Grid Expansion</h3>
...
<div className="p-stack-lg bg-surface border-t border-outline-variant flex flex-wrap justify-between items-center gap-3">
...
<button type="button" className="text-primary font-label-caps flex shrink-0 items-center hover:gap-2 transition-all">
...
<div className="p-stack-lg flex-1">
<div className="flex flex-wrap justify-between gap-x-3 gap-y-2 items-start mb-4">
<span className="shrink-0 px-3 py-1 bg-secondary-container text-on-secondary-container text-[10px] font-label-caps rounded-full uppercase">Mining</span>
<span className="font-data-tabular text-on-surface-variant flex shrink-0 items-center">
<span className="material-symbols-outlined text-[14px] mr-1">location_on</span> Guinea
                            </span>
</div>
<h3 className="font-headline-sm text-headline-sm text-primary mb-2 min-w-0 break-words">Boke Bauxite Corridor</h3>
...
<div className="p-stack-lg flex-1">
<div className="flex flex-wrap justify-between gap-x-3 gap-y-2 items-start mb-4">
<span className="shrink-0 px-3 py-1 bg-tertiary-fixed-dim text-on-tertiary-fixed-variant text-[10px] font-label-caps rounded-full uppercase">Agri-Tech</span>
<span className="font-data-tabular text-on-surface-variant flex shrink-0 items-center">
<span className="material-symbols-outlined text-[14px] mr-1">location_on</span> Rwanda
                            </span>
</div>
<h3 className="font-headline-sm text-headline-sm text-primary mb-2 min-w-0 break-words">Urban Vertical Farms</h3>
...
<div className="p-stack-lg flex-1">
<div className="flex flex-wrap justify-between gap-x-3 gap-y-2 items-start mb-4">
<span className="shrink-0 px-3 py-1 bg-primary-fixed text-on-primary-fixed-variant text-[10px] font-label-caps rounded-full uppercase">Logistics</span>
<span className="font-data-tabular text-on-surface-variant flex shrink-0 items-center">
<span className="material-symbols-outlined text-[14px] mr-1">location_on</span> Guinea
                            </span>
</div>
<h3 className="font-headline-sm text-headline-sm text-primary mb-2 min-w-0 break-words">Conakry Port Terminal Expansion</h3>
...
{/* Sidebar */}
<aside className="min-w-0 space-y-gutter lg:col-span-4">
{/* Trending Widget */}
...
<div className="flex min-w-0 gap-4 group cursor-pointer">
...
<h4 className="font-body-md font-bold text-primary group-hover:text-secondary transition-colors break-words">Kigali Semiconductor Park</h4>
...
<h4 className="font-body-md font-bold text-primary group-hover:text-secondary transition-colors break-words">Cross-Border Power Link</h4>
...
<h4 className="font-body-md font-bold text-primary group-hover:text-secondary transition-colors break-words">Pan-African Gateway</h4>
...
<li className="flex items-start justify-between gap-3 text-body-md text-primary font-medium hover:text-secondary cursor-pointer transition-colors">
<div className="flex min-w-0 flex-1 items-start gap-2">
<span className="material-symbols-outlined shrink-0 text-on-surface-variant">picture_as_pdf</span>
<span className="min-w-0 break-words">Rwanda H2 2024 Report</span>
                            </div>
<span className="material-symbols-outlined shrink-0 text-sm">download</span>
</li>
<li className="flex items-start justify-between gap-3 text-body-md text-primary font-medium hover:text-secondary cursor-pointer transition-colors">
<div className="flex min-w-0 flex-1 items-start gap-2">
<span className="material-symbols-outlined shrink-0 text-on-surface-variant">picture_as_pdf</span>
<span className="min-w-0 break-words">Guinea Mining Framework</span>
                            </div>
<span className="material-symbols-outlined shrink-0 text-sm">download</span>
</li>
<li className="flex items-start justify-between gap-3 text-body-md text-primary font-medium hover:text-secondary cursor-pointer transition-colors">
<div className="flex min-w-0 flex-1 items-start gap-2">
<span className="material-symbols-outlined shrink-0 text-on-surface-variant">description</span>
<span className="min-w-0 break-words">EastWest Ag-Tech Map</span>
                            </div>
<span className="material-symbols-outlined shrink-0 text-sm">download</span>
</li>
</ul>
...
<div className="px-margin-mobile md:px-margin-desktop py-8 border-t border-outline-variant text-center md:text-left">
